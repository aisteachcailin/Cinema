...
if(isset($_SESSION['user'])){
	...
	foreach($add_film as $key => $value){
            ...
            mysqli_query($link, "INSERT INTO `tickets` (`id`, `id_user`, `id_film`, `number_tickets`, '$place', '$status', '$price', '$day') VALUES (NULL, '$id_user', '$id_film', '$number_tickets', '$place', '$status', '$price', '$day')");
			}
