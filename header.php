            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="index.php?page=index" id="biglogo">
                            <img src="images/logo1.png" alt="">
                        </a>
                        <a href="index.php?page=index" id="minilogo">
                ...
                <div class="col-lg-2">
                    <div class="header__right">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="hidden_menu" ><img src="images/menu.png" alt=""></a>
